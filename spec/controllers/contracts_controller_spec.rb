...
describe ContractsController do
  ...
  let(:valid_attributes) { { "partner_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved contract as @contract" do
        ...
        post :create, {:contract => { "partner_id" => "invalid value" }}, valid_session
        assigns(:contract).should be_a_new(Contract)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested contract" do
        ...
        Contract.any_instance.should_receive(:update_attributes).with({ "partner_id" => "1" })
        put :update, {:id => contract.to_param, :contract => { "partner_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the contract as @contract" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Contract.any_instance.stub(:save).and_return(false)
        put :update, {:id => contract.to_param, :contract => { "partner_id" => "invalid value" }}, valid_session
        assigns(:contract).should eq(contract)
      end
